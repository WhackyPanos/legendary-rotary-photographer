...
class CharLCD(object):
    ...
    def __init__(self, config,
        ...
        self.rs = machine.Pin(config["rs"], machine.Pin.OUT)
        self.en = machine.Pin(config["en"], machine.Pin.OUT)
        self.d4 = machine.Pin(config["d4"], machine.Pin.OUT)
        self.d5 = machine.Pin(config["d5"], machine.Pin.OUT)
        self.d6 = machine.Pin(config["d6"], machine.Pin.OUT)
        self.d7 = machine.Pin(config["d7"], machine.Pin.OUT)
        self.cols = cols
        self.rows = rows
